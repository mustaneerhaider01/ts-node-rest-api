...
router.post("/create", postValidators.validateCreatePost, postController.create);
router.delete("/:postId/remove", postController.remove);
router.put("/:postId/edit", postValidators.validateCreatePost, postController.edit);
